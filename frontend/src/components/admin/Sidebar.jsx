...
const Sidebar = () => {
  ...
  const menuItems = [
    ...
    { path: '/admin/articles', label: 'Articles', icon: 'M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9.5a2.5 2.5 0 00-2.5-2.5H15M9 11l3 3m0 0l3-3m-3 3V8' },
    ...
    <div className="w-64 bg-white shadow-lg">
      <div className="flex flex-col h-full">
        ...
        <div className="p-4 border-t">
          ...
          <button
            onClick={logout}
            className="mt-4 w-full px-4 py-2 text-sm font-medium text-white bg-blue-600 rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
          >
            Logout
          </button>
        </div>
